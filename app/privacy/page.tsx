...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "Cookieを利用することで当サイトは利用者のコンピューターを識別できますが、氏名や住所などから個人を特定するものではありません。",
      "Googleを含む第三者配信事業者がCookieを使用することにより、利用者が当サイトや他のサイトに過去にアクセスした情報に基づいて広告を配信することがあります。",
      "パーソナライズ広告は、Googleの広告設定ページ（https://adssettings.google.com/）からいつでも無効にできます。第三者配信事業者による広告の無効化については、https://optout.aboutads.info/ もあわせてご参照ください。",
    ],
  },
  {
  ...
  {
    title: "9. 当サイトのツールで扱うデータについて",
    body: [
      "当サイトの画像編集・PDF編集・各種計算ツールは、すべて利用者のブラウザ内（クライアントサイド）で処理を行っています。",
      "アップロードされた画像・PDFや、入力された数値・テキストが当サイトのサーバーに送信・保存されることはありません。",
      "処理結果のダウンロードも利用者の端末内で完結します。",
    ],
  },
  {
    title: "10. お問い合わせ",
